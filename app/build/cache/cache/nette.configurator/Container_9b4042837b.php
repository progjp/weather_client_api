<?php
// source: phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon
// source: /var/www/symfony/app/./phpstan.neon
// source: array
...
class Container_9b4042837b extends _PHPStan_781aefaf6\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.diagnoseExtension' => ['092' => true, '0526' => true],
		...
		'phpstan.broker.expressionTypeResolverExtension' => ['0502' => true],
		'phpstan.properties.readWriteExtension' => ['0531' => true],
		'phpstan.additionalConstructorsExtension' => ['0531' => true],
		'phpstan.resultCacheMetaExtension' => ['0534' => true],
	];

	protected $types = ['container' => '_PHPStan_781aefaf6\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_781aefaf6\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'0142',
				'0143',
		...
		'PHPStan\Rules\Constants\MissingClassConstantTypehintRule' => [['rules.227']],
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [['rules.228']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [['rules.229']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [['rules.230']],
		'PHPStan\Rules\Methods\MissingMethodReturnTypehintRule' => [['rules.231']],
		'PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule' => [['rules.232']],
		'PHPStan\Rules\Properties\MissingPropertyTypehintRule' => [['rules.233']],
		'PHPStan\Rules\Symfony\ContainerInterfacePrivateServiceRule' => [['rules.234']],
		'PHPStan\Rules\Symfony\ContainerInterfaceUnknownServiceRule' => [['rules.235']],
		'PHPStan\Rules\Symfony\UndefinedArgumentRule' => [['rules.236']],
		'PHPStan\Rules\Symfony\InvalidArgumentDefaultValueRule' => [['rules.237']],
		'PHPStan\Rules\Symfony\UndefinedOptionRule' => [['rules.238']],
		'PHPStan\Rules\Symfony\InvalidOptionDefaultValueRule' => [['rules.239']],
		...
		'PHPStan\PhpDoc\StubFilesExtension' => [['044', '046', '047', '048', '0524', '0525']],
		...
		'PHPStan\Diagnose\DiagnoseExtension' => [0 => ['092', '0526'], 2 => [1 => 'phpstanDiagnoseExtension']],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0224', '0227', '0229', '0242', '0348', '0354', '0517']],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [
			['0294', '0491', '0492', '0493', '0494', '0496', '0504', '0509', '0530'],
		],
		...
		'PHPStan\Rules\BooleansInConditions\BooleanRuleHelper' => [['0438']],
		'PHPStan\Rules\Operators\OperatorRuleHelper' => [['0439']],
		'PHPStan\Rules\VariableVariables\VariablePropertyFetchRule' => [['0440']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedLooseComparisonRule' => [['0441']],
		'PHPStan\Rules\BooleansInConditions\BooleanInBooleanAndRule' => [['0442']],
		'PHPStan\Rules\BooleansInConditions\BooleanInBooleanNotRule' => [['0443']],
		'PHPStan\Rules\BooleansInConditions\BooleanInBooleanOrRule' => [['0444']],
		'PHPStan\Rules\BooleansInConditions\BooleanInDoWhileConditionRule' => [['0445']],
		'PHPStan\Rules\BooleansInConditions\BooleanInElseIfConditionRule' => [['0446']],
		'PHPStan\Rules\BooleansInConditions\BooleanInIfConditionRule' => [['0447']],
		'PHPStan\Rules\BooleansInConditions\BooleanInTernaryOperatorRule' => [['0448']],
		'PHPStan\Rules\BooleansInConditions\BooleanInWhileConditionRule' => [['0449']],
		'PHPStan\Rules\Cast\UselessCastRule' => [['0450']],
		'PHPStan\Rules\Classes\RequireParentConstructCallRule' => [['0451']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedBacktickRule' => [['0452']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedEmptyRule' => [['0453']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedImplicitArrayCreationRule' => [['0454']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedShortTernaryRule' => [['0455']],
		'PHPStan\Rules\ForeachLoop\OverwriteVariablesWithForeachRule' => [['0456']],
		'PHPStan\Rules\ForLoop\OverwriteVariablesWithForLoopInitRule' => [['0457']],
		'PHPStan\Rules\Functions\ArrayFilterStrictRule' => [['0458']],
		'PHPStan\Rules\Functions\ClosureUsesThisRule' => [['0459']],
		'PHPStan\Rules\Methods\WrongCaseOfInheritedMethodRule' => [['0460']],
		'PHPStan\Rules\Methods\IllegalConstructorMethodCallRule' => [['0461']],
		'PHPStan\Rules\Methods\IllegalConstructorStaticCallRule' => [['0462']],
		...
		'PHPStan\Symfony\ConsoleApplicationResolver' => [['0483']],
		'PHPStan\Symfony\ServiceMapFactory' => [['symfony.serviceMapFactory']],
		'PHPStan\Symfony\ServiceMap' => [['0484']],
		'PHPStan\Symfony\ParameterMapFactory' => [['symfony.parameterMapFactory']],
		'PHPStan\Symfony\ParameterMap' => [['0485']],
		'PHPStan\Symfony\MessageMapFactory' => [['symfony.messageMapFactory']],
		'PHPStan\Symfony\MessageMap' => [['0486']],
		'PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension' => [['0487', '0488', '0489', '0490']],
		'PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension' => [['0491', '0492', '0493', '0494']],
		'PHPStan\Type\Symfony\RequestDynamicReturnTypeExtension' => [['0495']],
		'PHPStan\Type\Symfony\RequestTypeSpecifyingExtension' => [['0496']],
		'PHPStan\Type\Symfony\InputBagDynamicReturnTypeExtension' => [['0497']],
		'PHPStan\Type\Symfony\HeaderBagDynamicReturnTypeExtension' => [['0498']],
		'PHPStan\Type\Symfony\SerializerDynamicReturnTypeExtension' => [['0499', '0500']],
		'PHPStan\Type\Symfony\EnvelopeReturnTypeExtension' => [['0501']],
		'PHPStan\Type\ExpressionTypeResolverExtension' => [['0502']],
		'PHPStan\Type\Symfony\MessengerHandleTraitReturnTypeExtension' => [['0502']],
		'PHPStan\Type\Symfony\InputInterfaceGetArgumentDynamicReturnTypeExtension' => [['0503']],
		'PHPStan\Type\Symfony\ArgumentTypeSpecifyingExtension' => [['0504']],
		'PHPStan\Type\Symfony\InputInterfaceHasArgumentDynamicReturnTypeExtension' => [['0505']],
		'PHPStan\Type\Symfony\GetOptionTypeHelper' => [['0506']],
		'PHPStan\Type\Symfony\InputInterfaceGetOptionDynamicReturnTypeExtension' => [['0507']],
		'PHPStan\Type\Symfony\InputInterfaceGetOptionsDynamicReturnTypeExtension' => [['0508']],
		'PHPStan\Type\Symfony\OptionTypeSpecifyingExtension' => [['0509']],
		'PHPStan\Type\Symfony\InputInterfaceHasOptionDynamicReturnTypeExtension' => [['0510']],
		'PHPStan\Type\Symfony\Config\ArrayNodeDefinitionPrototypeDynamicReturnTypeExtension' => [['0511']],
		'PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension' => [['0512', '0514', '0516']],
		'PHPStan\Type\Symfony\Config\PassParentObjectDynamicReturnTypeExtension' => [['0513', '0515']],
		'PHPStan\Type\Symfony\Config\TreeBuilderDynamicReturnTypeExtension' => [['0517']],
		'PHPStan\Type\Symfony\Config\TreeBuilderGetRootNodeDynamicReturnTypeExtension' => [['0518']],
		'PHPStan\Type\Symfony\KernelInterfaceDynamicReturnTypeExtension' => [['0519']],
		'PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension' => [['0520', '0521', '0522', '0523']],
		'PHPStan\Symfony\InputBagStubFilesExtension' => [['0524']],
		'PHPStan\Symfony\PasswordAuthenticatedUserStubFilesExtension' => [['0525']],
		'PHPStan\Symfony\SymfonyDiagnoseExtension' => [['0526']],
		'PHPStan\Type\Symfony\Form\FormInterfaceDynamicReturnTypeExtension' => [['0527']],
		'PHPStan\Type\Symfony\CommandGetHelperDynamicReturnTypeExtension' => [['0528']],
		'PHPStan\Type\Symfony\ResponseHeaderBagDynamicReturnTypeExtension' => [['0529']],
		'PHPStan\Type\Symfony\InputBagTypeSpecifyingExtension' => [['0530']],
		'PHPStan\Rules\Properties\ReadWritePropertiesExtension' => [['0531']],
		'PHPStan\Reflection\AdditionalConstructorsExtension' => [['0531']],
		'PHPStan\Symfony\RequiredAutowiringExtension' => [['0531']],
		'PHPStan\Type\Symfony\CacheInterfaceGetDynamicReturnTypeExtension' => [['0532']],
		'PHPStan\Type\Symfony\ExtensionGetConfigurationReturnTypeExtension' => [['0533']],
		'PHPStan\Analyser\ResultCache\ResultCacheMetaExtension' => [['0534']],
		'PHPStan\Symfony\SymfonyContainerResultCacheMetaExtension' => [['0534']],
	];
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/var/www/symfony/app']);
	}


	public function createService029(): PHPStan\Php\ComposerPhpVersionFactory
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['/var/www/symfony/app']);
	}
	...
	public function createService045(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('075'),
			[
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/Countable.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Psr/Cache/CacheException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Psr/Cache/CacheItemInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Psr/Cache/InvalidArgumentException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/FrameworkBundle/Controller/AbstractController.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/FrameworkBundle/KernelBrowser.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/FrameworkBundle/Test/KernelTestCase.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/FrameworkBundle/Test/TestContainer.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/SecurityBundle/DependencyInjection/Security/Factory/AuthenticatorFactoryInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/SecurityBundle/DependencyInjection/Security/Factory/FirewallListenerFactoryInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Command.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Exception/ExceptionInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Exception/InvalidArgumentException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Exception/LogicException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Helper/HelperInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Output/OutputInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/DependencyInjection/ContainerBuilder.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/DependencyInjection/Extension/ExtensionInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/EventDispatcher/EventDispatcherInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/EventDispatcher/EventSubscriberInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/EventDispatcher/GenericEvent.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/AbstractType.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/ChoiceList/Loader/ChoiceLoaderInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/Exception/ExceptionInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/Exception/RuntimeException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/Exception/TransformationFailedException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/DataTransformerInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormBuilderInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormConfigBuilderInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormConfigInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormFactoryInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormTypeExtensionInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormTypeInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormView.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/HttpFoundation/Cookie.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/HttpFoundation/HeaderBag.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/HttpFoundation/ParameterBag.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/HttpFoundation/Session.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Messenger/StampInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Messenger/Envelope.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/OptionsResolver/Exception/InvalidOptionsException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/OptionsResolver/Options.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Process/Exception/LogicException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Process/Process.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/AccessException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/ExceptionInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/InvalidArgumentException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/RuntimeException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/UnexpectedTypeException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/PropertyAccessorInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/PropertyPathInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Acl/Model/AclInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Acl/Model/EntryInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Core/Authentication/Token/TokenInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Core/Authorization/Voter/Voter.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Core/Authorization/Voter/VoterInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Encoder/ContextAwareDecoderInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Encoder/DecoderInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Encoder/EncoderInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/BadMethodCallException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/CircularReferenceException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/ExceptionInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/ExtraAttributesException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/InvalidArgumentException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/LogicException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/RuntimeException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/UnexpectedValueException.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/ContextAwareDenormalizerInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/ContextAwareNormalizerInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/DenormalizableInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/DenormalizerInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/NormalizableInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/NormalizerInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/Constraint.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/Constraints/Composite.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/Constraints/Compound.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/ConstraintViolationInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/ConstraintViolationListInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Contracts/Cache/CacheInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Contracts/Cache/CallbackInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Contracts/Cache/ItemInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Symfony/Contracts/Service/ServiceSubscriberInterface.stub',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/stubs/Twig/Node/Node.stub',
				'/var/www/symfony/app/stubs/SerializerInterface.stub',
				'/var/www/symfony/app/stubs/Envelope.stub',
			],
			['/var/www/symfony/app']
		);
	}
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_9b4042837b $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/var/www/symfony/app/build/cache/resultCache.php',
					$this->container->getParameter('analysedPaths'),
					['/var/www/symfony/app'],
					'max',
					null,
					[
						'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
						'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
						'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
						'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
					],
					[],
					['/var/www/symfony/app/var/cache/dev/Symfony/Config'],
					false
				);
			}
		};
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/var/www/symfony/app/build/cache/resultCache.php');
	}
	...
	public function createService070(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['/var/www/symfony/app'],
			[
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level10.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
				'/var/www/symfony/app/phpstan.neon',
				'/var/www/symfony/app/vendor/phpstan/phpstan-strict-rules/rules.neon',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/extension.neon',
				'/var/www/symfony/app/vendor/phpstan/phpstan-symfony/rules.neon',
			],
			null,
			[
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createService077(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/var/www/symfony/app',
			'/var/www/symfony/app/build/cache',
			[
				'phar:///var/www/symfony/app/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'/var/www/symfony/app/./phpstan.neon',
			],
	...
	{
		return new PHPStan\File\FileHelper('/var/www/symfony/app');
	}
	...
	public function createService086(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('087'),
			['analyseAndScan' => [], 'analyse' => ['/var/www/symfony/app/src/Util', '/var/www/symfony/app/config']]
		);
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchCheck($this->getService('0181'), true, false, false);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0178'), $this->getService('0179'), true, false);
	}


	public function createService0158(): PHPStan\Rules\Methods\MethodCallCheck
	{
		return new PHPStan\Rules\Methods\MethodCallCheck($this->getService('reflectionProvider'), $this->getService('0181'), true, true);
	}
	...
	{
		return new PHPStan\Rules\Methods\MethodSignatureRule($this->getService('0115'), true, true);
	}
	...
	{
		return new PHPStan\Rules\RuleLevelHelper($this->getService('reflectionProvider'), true, false, true, true, true, false);
	}
	...
	{
		return new PHPStan\Rules\Properties\OverridingPropertyRule($this->getService('026'), true, true);
	}


	public function createService0379(): PHPStan\Rules\Properties\SetPropertyHookParameterRule
	{
		return new PHPStan\Rules\Properties\SetPropertyHookParameterRule($this->getService('0163'), true, true);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/var/www/symfony/app');
	}
	...
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('0147'), $this->getService('0181'), true);
	}
	...
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule($this->getService('0181'), true);
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0181'), $this->getService('0131'), true);
	}
	...
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0181'), true);
	}
	...
	public function createService0438(): PHPStan\Rules\BooleansInConditions\BooleanRuleHelper
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanRuleHelper($this->getService('0181'));
	}


	public function createService0439(): PHPStan\Rules\Operators\OperatorRuleHelper
	{
		return new PHPStan\Rules\Operators\OperatorRuleHelper($this->getService('0181'));
	}


	public function createService0440(): PHPStan\Rules\VariableVariables\VariablePropertyFetchRule
	{
		return new PHPStan\Rules\VariableVariables\VariablePropertyFetchRule($this->getService('reflectionProvider'), ['stdClass']);
	}


	public function createService0441(): PHPStan\Rules\DisallowedConstructs\DisallowedLooseComparisonRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedLooseComparisonRule;
	}


	public function createService0442(): PHPStan\Rules\BooleansInConditions\BooleanInBooleanAndRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInBooleanAndRule($this->getService('0438'));
	}


	public function createService0443(): PHPStan\Rules\BooleansInConditions\BooleanInBooleanNotRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInBooleanNotRule($this->getService('0438'));
	}


	public function createService0444(): PHPStan\Rules\BooleansInConditions\BooleanInBooleanOrRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInBooleanOrRule($this->getService('0438'));
	}


	public function createService0445(): PHPStan\Rules\BooleansInConditions\BooleanInDoWhileConditionRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInDoWhileConditionRule($this->getService('0438'));
	}


	public function createService0446(): PHPStan\Rules\BooleansInConditions\BooleanInElseIfConditionRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInElseIfConditionRule($this->getService('0438'));
	}


	public function createService0447(): PHPStan\Rules\BooleansInConditions\BooleanInIfConditionRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInIfConditionRule($this->getService('0438'));
	}


	public function createService0448(): PHPStan\Rules\BooleansInConditions\BooleanInTernaryOperatorRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInTernaryOperatorRule($this->getService('0438'));
	}


	public function createService0449(): PHPStan\Rules\BooleansInConditions\BooleanInWhileConditionRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInWhileConditionRule($this->getService('0438'));
	}


	public function createService0450(): PHPStan\Rules\Cast\UselessCastRule
	{
		return new PHPStan\Rules\Cast\UselessCastRule(false, true);
	}


	public function createService0451(): PHPStan\Rules\Classes\RequireParentConstructCallRule
	{
		return new PHPStan\Rules\Classes\RequireParentConstructCallRule;
	}


	public function createService0452(): PHPStan\Rules\DisallowedConstructs\DisallowedBacktickRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedBacktickRule;
	}


	public function createService0453(): PHPStan\Rules\DisallowedConstructs\DisallowedEmptyRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedEmptyRule;
	}


	public function createService0454(): PHPStan\Rules\DisallowedConstructs\DisallowedImplicitArrayCreationRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedImplicitArrayCreationRule;
	}


	public function createService0455(): PHPStan\Rules\DisallowedConstructs\DisallowedShortTernaryRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedShortTernaryRule;
	}


	public function createService0456(): PHPStan\Rules\ForeachLoop\OverwriteVariablesWithForeachRule
	{
		return new PHPStan\Rules\ForeachLoop\OverwriteVariablesWithForeachRule;
	}


	public function createService0457(): PHPStan\Rules\ForLoop\OverwriteVariablesWithForLoopInitRule
	{
		return new PHPStan\Rules\ForLoop\OverwriteVariablesWithForLoopInitRule;
	}


	public function createService0458(): PHPStan\Rules\Functions\ArrayFilterStrictRule
	{
		return new PHPStan\Rules\Functions\ArrayFilterStrictRule($this->getService('reflectionProvider'), false, true, true);
	}


	public function createService0459(): PHPStan\Rules\Functions\ClosureUsesThisRule
	{
		return new PHPStan\Rules\Functions\ClosureUsesThisRule;
	}


	public function createService0460(): PHPStan\Rules\Methods\WrongCaseOfInheritedMethodRule
	{
		return new PHPStan\Rules\Methods\WrongCaseOfInheritedMethodRule;
	}


	public function createService0461(): PHPStan\Rules\Methods\IllegalConstructorMethodCallRule
	{
		return new PHPStan\Rules\Methods\IllegalConstructorMethodCallRule;
	}


	public function createService0462(): PHPStan\Rules\Methods\IllegalConstructorStaticCallRule
	{
	...
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticPostDecrementRule($this->getService('0439'));
	}


	public function createService0464(): PHPStan\Rules\Operators\OperandInArithmeticPostIncrementRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticPostIncrementRule($this->getService('0439'));
	}


	public function createService0465(): PHPStan\Rules\Operators\OperandInArithmeticPreDecrementRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticPreDecrementRule($this->getService('0439'));
	}


	public function createService0466(): PHPStan\Rules\Operators\OperandInArithmeticPreIncrementRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticPreIncrementRule($this->getService('0439'));
	}


	public function createService0467(): PHPStan\Rules\Operators\OperandsInArithmeticAdditionRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticAdditionRule($this->getService('0439'));
	}


	public function createService0468(): PHPStan\Rules\Operators\OperandsInArithmeticDivisionRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticDivisionRule($this->getService('0439'));
	}


	public function createService0469(): PHPStan\Rules\Operators\OperandsInArithmeticExponentiationRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticExponentiationRule($this->getService('0439'));
	}


	public function createService0470(): PHPStan\Rules\Operators\OperandsInArithmeticModuloRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticModuloRule($this->getService('0439'));
	}


	public function createService0471(): PHPStan\Rules\Operators\OperandsInArithmeticMultiplicationRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticMultiplicationRule($this->getService('0439'));
	}


	public function createService0472(): PHPStan\Rules\Operators\OperandsInArithmeticSubtractionRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticSubtractionRule($this->getService('0439'));
	}


	public function createService0473(): PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsRule
	{
		return new PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsRule($this->getService('0181'));
	}


	public function createService0474(): PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsCallableRule
	{
		return new PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsCallableRule($this->getService('0181'));
	}
	...
	{
		return new PHPStan\Rules\SwitchConditions\MatchingTypeInSwitchCaseConditionRule($this->getService('024'));
	}
	...
	public function createService0483(): PHPStan\Symfony\ConsoleApplicationResolver
	{
		return new PHPStan\Symfony\ConsoleApplicationResolver(null);
	}


	public function createService0484(): PHPStan\Symfony\ServiceMap
	{
		return $this->getService('symfony.serviceMapFactory')->create();
	}


	public function createService0485(): PHPStan\Symfony\ParameterMap
	{
		return $this->getService('symfony.parameterMapFactory')->create();
	}


	public function createService0486(): PHPStan\Symfony\MessageMap
	{
		return $this->getService('symfony.messageMapFactory')->create();
	}


	public function createService0487(): PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension
	{
	...
	public function createService0488(): PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension(
	...
	public function createService0489(): PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension(
	...
	public function createService0491(): PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension
	{
	...
	public function createService0492(): PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension('Psr\Container\ContainerInterface', $this->getService('024'));
	}


	public function createService0493(): PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension(
			'Symfony\Bundle\FrameworkBundle\Controller\Controller',
			$this->getService('024')
	...
	public function createService0495(): PHPStan\Type\Symfony\RequestDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\RequestDynamicReturnTypeExtension;
	}


	public function createService0496(): PHPStan\Type\Symfony\RequestTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\RequestTypeSpecifyingExtension;
	}


	public function createService0497(): PHPStan\Type\Symfony\InputBagDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\InputBagDynamicReturnTypeExtension;
	}


	public function createService0498(): PHPStan\Type\Symfony\HeaderBagDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\HeaderBagDynamicReturnTypeExtension;
	}


	public function createService0499(): PHPStan\Type\Symfony\SerializerDynamicReturnTypeExtension
	{
	...
	public function createService0500(): PHPStan\Type\Symfony\SerializerDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\SerializerDynamicReturnTypeExtension(
	...
	public function createService0501(): PHPStan\Type\Symfony\EnvelopeReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\EnvelopeReturnTypeExtension;
	}


	public function createService0502(): PHPStan\Type\Symfony\MessengerHandleTraitReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\MessengerHandleTraitReturnTypeExtension($this->getService('symfony.messageMapFactory'));
	}


	public function createService0503(): PHPStan\Type\Symfony\InputInterfaceGetArgumentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\InputInterfaceGetArgumentDynamicReturnTypeExtension($this->getService('0483'));
	}


	public function createService0504(): PHPStan\Type\Symfony\ArgumentTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\ArgumentTypeSpecifyingExtension($this->getService('024'));
	}


	public function createService0505(): PHPStan\Type\Symfony\InputInterfaceHasArgumentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\InputInterfaceHasArgumentDynamicReturnTypeExtension($this->getService('0483'));
	}


	public function createService0506(): PHPStan\Type\Symfony\GetOptionTypeHelper
	{
		return new PHPStan\Type\Symfony\GetOptionTypeHelper;
	}


	public function createService0507(): PHPStan\Type\Symfony\InputInterfaceGetOptionDynamicReturnTypeExtension
	{
	...
	public function createService0508(): PHPStan\Type\Symfony\InputInterfaceGetOptionsDynamicReturnTypeExtension
	{
	...
	public function createService0509(): PHPStan\Type\Symfony\OptionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\OptionTypeSpecifyingExtension($this->getService('024'));
	}


	public function createService0510(): PHPStan\Type\Symfony\InputInterfaceHasOptionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\InputInterfaceHasOptionDynamicReturnTypeExtension($this->getService('0483'));
	}


	public function createService0511(): PHPStan\Type\Symfony\Config\ArrayNodeDefinitionPrototypeDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\ArrayNodeDefinitionPrototypeDynamicReturnTypeExtension;
	}


	public function createService0512(): PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension
	{
	...
	public function createService0513(): PHPStan\Type\Symfony\Config\PassParentObjectDynamicReturnTypeExtension
	{
	...
	public function createService0514(): PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension(
			'Symfony\Component\Config\Definition\Builder\NodeBuilder',
			['end']
	...
	public function createService0515(): PHPStan\Type\Symfony\Config\PassParentObjectDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\PassParentObjectDynamicReturnTypeExtension(
	...
	public function createService0516(): PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension(
			'Symfony\Component\Config\Definition\Builder\NodeDefinition',
			['end']
	...
	public function createService0517(): PHPStan\Type\Symfony\Config\TreeBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\TreeBuilderDynamicReturnTypeExtension;
	}


	public function createService0518(): PHPStan\Type\Symfony\Config\TreeBuilderGetRootNodeDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\TreeBuilderGetRootNodeDynamicReturnTypeExtension;
	}


	public function createService0519(): PHPStan\Type\Symfony\KernelInterfaceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\KernelInterfaceDynamicReturnTypeExtension;
	}


	public function createService0520(): PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension
	{
	...
	public function createService0521(): PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension(
			'Symfony\Component\DependencyInjection\ContainerInterface',
			'getParameter',
	...
	public function createService0522(): PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension(
			'Symfony\Bundle\FrameworkBundle\Controller\AbstractController',
			'getParameter',
	...
	public function createService0524(): PHPStan\Symfony\InputBagStubFilesExtension
	{
		return new PHPStan\Symfony\InputBagStubFilesExtension($this->getService('originalBetterReflectionReflector'));
	}


	public function createService0525(): PHPStan\Symfony\PasswordAuthenticatedUserStubFilesExtension
	{
		return new PHPStan\Symfony\PasswordAuthenticatedUserStubFilesExtension($this->getService('originalBetterReflectionReflector'));
	}


	public function createService0526(): PHPStan\Symfony\SymfonyDiagnoseExtension
	{
		return new PHPStan\Symfony\SymfonyDiagnoseExtension($this->getService('0483'));
	}


	public function createService0527(): PHPStan\Type\Symfony\Form\FormInterfaceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Form\FormInterfaceDynamicReturnTypeExtension;
	}


	public function createService0528(): PHPStan\Type\Symfony\CommandGetHelperDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\CommandGetHelperDynamicReturnTypeExtension($this->getService('0483'));
	}


	public function createService0529(): PHPStan\Type\Symfony\ResponseHeaderBagDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ResponseHeaderBagDynamicReturnTypeExtension;
	}


	public function createService0530(): PHPStan\Type\Symfony\InputBagTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\InputBagTypeSpecifyingExtension;
	}


	public function createService0531(): PHPStan\Symfony\RequiredAutowiringExtension
	{
		return new PHPStan\Symfony\RequiredAutowiringExtension($this->getService('0184'));
	}


	public function createService0532(): PHPStan\Type\Symfony\CacheInterfaceGetDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\CacheInterfaceGetDynamicReturnTypeExtension;
	}


	public function createService0533(): PHPStan\Type\Symfony\ExtensionGetConfigurationReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ExtensionGetConfigurationReturnTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0534(): PHPStan\Symfony\SymfonyContainerResultCacheMetaExtension
	{
		return new PHPStan\Symfony\SymfonyContainerResultCacheMetaExtension($this->getService('0485'), $this->getService('0484'));
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/var/www/symfony/app/build/cache/cache/PHPStan');
	}


	public function createServiceContainer(): Container_9b4042837b
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderAnalyse'), $this->getService('085'), ['php', 'php', 'dist']);
	}


	public function createServiceFileFinderScan(): PHPStan\File\FileFinder
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderScan'), $this->getService('085'), ['php', 'php', 'dist']);
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/var/www/symfony/app');
	}
	...
	public function createServiceRules__227(): PHPStan\Rules\Constants\MissingClassConstantTypehintRule
	{
		return new PHPStan\Rules\Constants\MissingClassConstantTypehintRule($this->getService('0163'));
	}


	public function createServiceRules__228(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('0163'));
	}


	public function createServiceRules__229(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('0163'));
	}
	...
	public function createServiceRules__230(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodParameterTypehintRule($this->getService('0163'));
	}


	public function createServiceRules__231(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('0163'));
	}


	public function createServiceRules__232(): PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule
	{
		return new PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule($this->getService('0163'));
	}


	public function createServiceRules__233(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
		return new PHPStan\Rules\Properties\MissingPropertyTypehintRule($this->getService('0163'));
	}


	public function createServiceRules__234(): PHPStan\Rules\Symfony\ContainerInterfacePrivateServiceRule
	{
		return new PHPStan\Rules\Symfony\ContainerInterfacePrivateServiceRule($this->getService('0484'));
	}


	public function createServiceRules__235(): PHPStan\Rules\Symfony\ContainerInterfaceUnknownServiceRule
	{
		return new PHPStan\Rules\Symfony\ContainerInterfaceUnknownServiceRule($this->getService('0484'), $this->getService('024'));
	}


	public function createServiceRules__236(): PHPStan\Rules\Symfony\UndefinedArgumentRule
	{
		return new PHPStan\Rules\Symfony\UndefinedArgumentRule($this->getService('0483'), $this->getService('024'));
	}


	public function createServiceRules__237(): PHPStan\Rules\Symfony\InvalidArgumentDefaultValueRule
	{
		return new PHPStan\Rules\Symfony\InvalidArgumentDefaultValueRule;
	}


	public function createServiceRules__238(): PHPStan\Rules\Symfony\UndefinedOptionRule
	{
		return new PHPStan\Rules\Symfony\UndefinedOptionRule($this->getService('0483'), $this->getService('024'));
	}


	public function createServiceRules__239(): PHPStan\Rules\Symfony\InvalidOptionDefaultValueRule
	{
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/var/www/symfony/app');
	}
	...
	{
		return new PHPStan\Symfony\MessageMapFactory($this->getService('0484'), $this->getService('reflectionProvider'));
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => [
				'analyseAndScan' => [],
				'analyse' => ['/var/www/symfony/app/src/Util', '/var/www/symfony/app/config'],
			],
			'level' => 'max',
			'paths' => ['/var/www/symfony/app/src', '/var/www/symfony/app/config'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'mixinExcludeClasses' => [],
			'scanFiles' => [],
			'scanDirectories' => ['/var/www/symfony/app/var/cache/dev/Symfony/Config'],
			'parallel' => [
				'jobSize' => 20,
			...
			'resultCachePath' => '/var/www/symfony/app/build/cache/resultCache.php',
			...
			'tmpDir' => '/var/www/symfony/app/build/cache',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/var/www/symfony/app/build/cache',
			'rootDir' => '/var/www/symfony/app/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/var/www/symfony/app',
			...
			'composerAutoloaderProjectPaths' => ['/var/www/symfony/app'],
			'generateBaselineFile' => null,
			'usedLevel' => 'max',
			'cliAutoloadFile' => null,
			'env' => [
				'API_URL' => 'https://api.weatherapi.com/v1',
				'HOSTNAME' => '95d2b4a9603f',
				'PHP_VERSION' => '8.4.5',
				'PHP_INI_DIR' => '/usr/local/etc/php',
				'GPG_KEYS' => 'AFD8691FDAEDF03BDF6E460563F15A9B715376CA 9D7F99A0CB8F05C8A6958D6256A97AF7600A39A6 0616E93D95AF471243E26761770426E17EBBB3DD',
				'PHP_LDFLAGS' => '-Wl,-O1 -pie',
				'PWD' => '/var/www/symfony/app',
				'API_KEY' => '40b48ae1d4d64305b4a90226251803',
				'HOME' => '/root',
				'APP_ENV' => 'dev',
