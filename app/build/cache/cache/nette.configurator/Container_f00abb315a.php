...
class Container_f00abb315a extends _PHPStan_781aefaf6\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f00abb315a $container)
			{
	...
	public function createServiceContainer(): Container_f00abb315a
	{
		return $this;
	}
